...
int main() {
    int mode = 0; // 0: minimize, 1: maximize
    ...
    // int n = 3, m = 3;
    // float cost[3][3] = {{5, 9, 1},
    //                     {10, 3, 2},
    //                     {8, 7, 4}};

    // int n = 3, m = 3;
    // float cost[3][3] = {{2, 3, 3},
    //                      {3, 2, 3},
    //                      {3, 3, 2}};

    // int n = 4, m = 4;
	// float cost[4][4] = {{82,83,69,92},
    //                     {77,37,49,92},
    //                     {11,69,5,86},
    //                     {8,9,98,23}};

    // int n = 4, m = 4;
    // float cost[4][4] = {{3, 4, 5, 6},
    //                     {7, 3, 4, 7},
    //                     {6, 5, 6, 3},
    //                     {2, 8, 5, 7}};

    int n = 3, m = 4;
    float cost[3][4] = {{3, 7, 5, 11},
                        {5, 4, 6, 3},
                        {6, 10, 1, 1}};

    std::vector<int> assignment_index(n, -1);
    float total_cost = solve(&cost[0][0], n, m, mode, &assignment_index[0]);

    cout << "Total cost: " << total_cost << "\n";
    cout << "Assignment index: ";
    for (auto& i : assignment_index)
        cout << i << " ";
    cout << "\n";
